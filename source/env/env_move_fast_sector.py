...
from env_move_fast import MoveFastAction
...
class HumanMoveFastSectorAction(MoveFastAction):
            ...
            if True:#self.reward_object_use > 0:
                ...
                for k_s in keys_left_right:
                    ...
                    if move_along_sector == k_s:
                        ...
                        self.reward_object_move = 0.0002 * ((math.pi - abs(move_d_phi_bind))/math.pi) * (0.3 - density) 
                        break
                    num_move += 1
